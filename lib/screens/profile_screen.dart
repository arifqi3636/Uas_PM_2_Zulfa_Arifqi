              ...
              child: Column(
                ...
                if (_isEditing) ...[
                  ...
                  TextFormField(
                    ...
                    readOnly: true, // Email can't be changed easily in Firebase
                  ),
                ] else ...[
                  Card(
                    elevation: 4,
                      ...
                      child: Column(
                        children: [
                          ...
                          ListTile(
                            ...
                            subtitle: Text(user?.emailVerified == true ? 'Terverifikasi' : 'Belum Terverifikasi'),
                          ),
                        ],
                      ),
                    ),
                ...
                if (_isEditing)
                  ...
                  ElevatedButton.icon(
                    onPressed: () {
                      Provider.of<auth_provider.AuthProvider>(context, listen: false).logout();
                    },
